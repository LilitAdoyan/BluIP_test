...
It was challenging for me to work wit Express.js and create different routes because previously I only forked with frontend. It seems a small mistake but at first I put the api key inside quotation marks and couldn't get the data from the api.
